    ...
    return (
        ...
        <div className=' lg:flex 2xl:gap-52 xl:gap-32   h-screen '>
            ...
            <div className='left-side '>
                ...
                <Image src="/login.png" alt="login-image" width={527.04} height={498.58} className='ez-rent-image-signup' />
            ...
            <Image src="/logo-1.png" alt="logo" width={122} height={122} className='lg:hidden block' />
                ...
                <div className='  right-side-sub-box'>
                    <div className='mx-10'>
                        ...
                        <label className='text-start 2xl:text-[20px] text-[14px]'>Confirm Password</label>
                        <div className=' 2xl:mt-3 mt-1 relative flex justify-between  items-center'>
                            <input type='password' className='2xl:h-[66px] h-[44px] focus:border-[#404EED] 2xl:rounded-3xl rounded-[17px] border-2 px-5 outline-none w 2xl:text-[18px] w-[100%] text-[14px]' />
                            <BiHide className="text-3xl text-[#404EED] lg:text-[18px] text-[14px] absolute right-5    " />
                        </div>
                        <button className='w-full 2xl:mt-12 mt-5 2xl:h-[65px] h-[45px] rounded-full text-center text-white 2xl:text-[20px] text-[14px] bg-[#0F172A]'><Link href={"/verification"}>Signup</Link></button>
